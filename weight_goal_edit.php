...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE `user_goals` SET `weight_goal`='$weight_goal' WHERE weight_id = $weight_id";
    ...
    <div class="container">
        ...
        <div class="container-main d-flex justify-content-center">
            <form action="" method="post" style="width:50vw; min-width:300px;">
                <div class="row mb-3">
                    <div class="col">
                        <label class="form-label">Weight Goal(lbs):</label>
                        <input type="number" class="form-control" name="weight_goal" value="<?php echo $row['weight_goal'] ?>" required>
                    </div>
